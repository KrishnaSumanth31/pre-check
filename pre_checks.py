        ...
        for file in files:
            ...
            if os.path.isfile(file_path):
                if validate_file_name(file):
                    print(f"INFO: Valid filename: {file} - Valid file path: {file_path}")
                        ...
                        if details:
                            ...
                            if tasks:
                                for task in tasks:
                                    ...
                                    print(f"INFO: All required values for task {postgre_table_name} are valid.")
                            else:
                                print("INFO: No tasks found.")
                        else:
                            print("INFO: No details found.")
                else:
